...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7960681471753432050L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"employee.avro.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"},{\"name\":\"department\",\"type\":\"string\"}]}");
   ...
   */
  public static employee.avro.schema.Employee.Builder newBuilder() {
    return new employee.avro.schema.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static employee.avro.schema.Employee.Builder newBuilder(employee.avro.schema.Employee.Builder other) {
    return new employee.avro.schema.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static employee.avro.schema.Employee.Builder newBuilder(employee.avro.schema.Employee other) {
    return new employee.avro.schema.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(employee.avro.schema.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(employee.avro.schema.Employee other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder setId(int value) {
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder clearId() {
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder setFirstName(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder clearFirstName() {
      firstName = null;
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder setLastName(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder clearLastName() {
      lastName = null;
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder setDepartment(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public employee.avro.schema.Employee.Builder clearDepartment() {
      department = null;
