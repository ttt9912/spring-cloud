...
public class EmployeeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -1168238571647586845L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeKey\",\"namespace\":\"employee.avro.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"departmentName\",\"type\":\"string\"}]}");
     ...
     */
    public static employee.avro.schema.EmployeeKey.Builder newBuilder() {
        return new employee.avro.schema.EmployeeKey.Builder();
    }
     ...
     * @return A new EmployeeKey RecordBuilder
     */
    public static employee.avro.schema.EmployeeKey.Builder newBuilder(employee.avro.schema.EmployeeKey.Builder other) {
        return new employee.avro.schema.EmployeeKey.Builder(other);
    }
     ...
     * @return A new EmployeeKey RecordBuilder
     */
    public static employee.avro.schema.EmployeeKey.Builder newBuilder(employee.avro.schema.EmployeeKey other) {
        return new employee.avro.schema.EmployeeKey.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeKey>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(employee.avro.schema.EmployeeKey.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(employee.avro.schema.EmployeeKey other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public employee.avro.schema.EmployeeKey.Builder setId(int value) {
         ...
         * @return This builder.
         */
        public employee.avro.schema.EmployeeKey.Builder clearId() {
         ...
         * @return This builder.
         */
        public employee.avro.schema.EmployeeKey.Builder setDepartmentName(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public employee.avro.schema.EmployeeKey.Builder clearDepartmentName() {
            departmentName = null;
